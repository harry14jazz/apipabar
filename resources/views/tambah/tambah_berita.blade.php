      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Tambah Berita Covid</h1>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route ('home admin') }}">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{ route ('berita') }}">Berita</a></li>
                    <li class="breadcrumb-item active">Tambah Berita Covid</li>
                </ol>
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="card">
            <div class="card-body">
            <form action="/admin/berita/tambah_berita/simpan" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
